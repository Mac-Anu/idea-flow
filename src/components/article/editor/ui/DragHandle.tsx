...
export function DragHandle({ editor }: { editor: Editor | null }) {
    ...
    return (
        <div className="custom-drag-handle drag-handle hide flex items-center justify-end gap-1 w-[24px] h-[28px] rounded opacity-0 transition-opacity duration-200 text-muted-foreground pr-2">
            <button
